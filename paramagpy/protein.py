...
#     ('nc', 'i4'),          # Number of columns
#     ('nr', 'i4'),          # Number of rows
#     ('ns', 'i4'),          # Number of sections
#     ('mode', 'i4'),        # Mode; indicates type of values stored in data block
#     ('ncstart', 'i4'),     # Number of first column in map
#     ('nrstart', 'i4'),     # Number of first row in map
#     ('nsstart', 'i4'),     # Number of first section in map
#     ('nx', 'i4'),          # Number of intervals along x
#     ('ny', 'i4'),          # Number of intervals along y
#     ('nz', 'i4'),          # Number of intervals along z
#     ('x', 'f4'),           # Cell dimension along x in Angstrom
#     ('y', 'f4'),           # Cell dimension along y in Angstrom
#     ('z', 'f4'),           # Cell dimension along z in Angstrom
#     ('alpha', 'f4'),       # Cell angle alpha
#     ('beta', 'f4'),        # Cell angle beta
#     ('gamma', 'f4'),       # Cell angle gamma
#     ('mapc', 'i4'),        # mapping for column  1=x,2=y,3=z.
#     ('mapr', 'i4'),        # mapping for row     1=x,2=y,3=z.
#     ('maps', 'i4'),        # mapping for section 1=x,2=y,3=z.
...
#     ('lskflg', 'i4'),      # Flag for skew transformation, =0 none, =1 if foll
#     ('skwmat', 'f4', 9),   # Skew matrix S (in order S11, S12, S13, S21 etc)
#     ('skwtrn', 'f4', 3),   # Skew transformation vector
#     ('future', 'V60'),     # reserved for future use
#     ('map', 'S4'),         # Contains 'MAP ' to identify file type
#     ('machst', 'u1', 4),   # Machine stamp; identifies byte order
#     ('arms', 'f4'),        # RMS deviation of densities from mean density
#     ('nlabl', 'i4'),       # Number of labels with useful data
#     ('label', 'S80', 10)   # 10 labels of 80 characters
# ])


# d = DensityMap(np.array([0,0,0]), 40, 2)

# print(d.make_pymol_script('hi', 'test.ccp4', [-1,1], 
# 	opts=[["set transparency, 0.5, {}"], ["set transparency, 0.5, {}"]]))
